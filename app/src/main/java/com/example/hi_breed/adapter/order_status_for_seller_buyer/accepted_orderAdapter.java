...
public class accepted_orderAdapter extends RecyclerView.Adapter<accepted_orderAdapter.ViewHolder> {
        Context context;
    private List<appointment_order_class> list;
    private String userID;
    public accepted_orderAdapter(Context context, String userID){
