...
public class product_edit_adapter extends RecyclerView.Adapter<product_edit_adapter.ViewHolder> {
    ...
    public product_edit_adapter(ArrayList<Uri> uriArrayList, Context context, CountOfImagesCurrent countCurrent
    ...
    @NonNull
    @Override
    public product_edit_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull product_edit_adapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
