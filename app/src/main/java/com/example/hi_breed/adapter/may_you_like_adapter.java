...
public class may_you_like_adapter extends RecyclerView.Adapter<may_you_like_adapter.ViewHolder> {

    Context context;
    List<likes_class> cart;

    public may_you_like_adapter(Context context ){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.may_you_like_layout,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder v, int position) {
            ...
            //forSale
            //Services
            if(add.getCategory().equals("forSale")) {
                FirebaseFirestore.getInstance().collection("Pet")
                        .document(add.getProduct_id())
                        .get()
            ...
            else if(add.getCategory().equals("Medicine") || add.getCategory().equals("Dog Accessories") ){
                FirebaseFirestore.getInstance().collection("Pet")
                        .document(add.getProduct_id())
                        .get()
                        .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
