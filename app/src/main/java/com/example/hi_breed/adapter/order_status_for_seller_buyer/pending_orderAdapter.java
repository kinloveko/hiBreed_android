...
public class pending_orderAdapter extends RecyclerView.Adapter<pending_orderAdapter.ViewHolder> {
        Context context;
    private List<appointment_order_class> list;
    private String userID;
    public pending_orderAdapter(Context context, String userID){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.order_status_layout_pending,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(productModel.getCustomer_id().equals(userID))
        {
            ...
            holder.text.setText("VIEW YOUR ORDER");
            ...
            holder.text.setText("VIEW ORDER");
