...
public class edit_post_ask_prof_adapter extends RecyclerView.Adapter<edit_post_ask_prof_adapter.ViewHolder> {
    ...
    public edit_post_ask_prof_adapter(ArrayList<Uri> uriArrayList, Context context, CountOfImagesCurrent countCurrent
    ...
    @NonNull
    @Override
    public edit_post_ask_prof_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull edit_post_ask_prof_adapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.deleteImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(position < uriArrayLists.size()){
                    String uri = String.valueOf(uriArrayLists.get(position));
                    FirebaseFirestore.getInstance().collection("Post")
                            .document(id)
                            .update("photos", FieldValue.arrayRemove(uriArrayLists.get(position))).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                    ...
                    Toast.makeText(context, "Invalid index passed to the method", Toast.LENGTH_SHORT).show();
                }
