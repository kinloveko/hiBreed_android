...
import com.example.hi_breed.classesFile.PapersClass;
...
public class pet_add_for_selling extends BaseActivity implements petImagesRecyclerAdapter.CountOfImagesWhenRemovedPet,  petImagesRecyclerAdapter.itemClickListenerPet, shooter_proof_RecyclerAdapter.itemClickListeners,shooter_proof_RecyclerAdapter.CountOfImagesWhenRemoves {
    ...
    RecyclerView pet_paper_view;
    petImagesRecyclerAdapter pet_adapter;
    shooter_proof_RecyclerAdapter pet_paper_adapter;
    ArrayList<String> saveVaccine = new ArrayList<>();
    ArrayList<Uri> uri = new ArrayList<>();
    ArrayList<Uri> uriPapers = new ArrayList<>();
    int countOfPapers;
    Uri imageUriPapers;
    Uri imageUri;
    int countOfImages;
    String numberHolder;
    TextView petKiloTextView,petSizeTextView,genderTextView,petBreedTextView,petBirthdayTextView,petPriceTextView,petNameCount,petDescCount,petColorCount,dewormingTextView,dewormCountOfTimes,text3,text4;
    String kennel;
    //Relative Layout
    RelativeLayout sizeLayout,kiloLayout,genderLayout,categoryLayout,birthdayLayout,priceLayout,vaccineLayout;
    //Linear Layout
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pet_add_for_selling);
        ...
        //RecyclerView
        pet_paper_view = findViewById(R.id.pet_papers_view0);
        pet_images_view = findViewById(R.id.pet_images_view);
        //for papers
        pet_paper_adapter = new shooter_proof_RecyclerAdapter(uriPapers,getApplicationContext(),this,this);
        pet_paper_view.setLayoutManager(new GridLayoutManager(this,4));
        pet_paper_view.setAdapter(pet_paper_adapter);
        ...
        backLayoutPet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                pet_add_for_selling.this.onBackPressed();
                finish();
            }
        });
        ...
        okay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(editText.getText().toString().equals("")  || editText.getText().toString() == null){
                    count = 0;
                    Toast.makeText(pet_add_for_selling.this, "Oops. You made no entry! a Pet size was expected", Toast.LENGTH_SHORT).show();
                }
                else{
                    petSizeTextView.setText(editText.getText().toString());
                    Toast.makeText(pet_add_for_selling.this, editText.getText().toString(), Toast.LENGTH_SHORT).show();
                    count = 1;
                }
                if(count != 0){
                    alert3.dismiss();
        ...
        okay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(editText.getText().toString().equals("") || editText.getText().toString().equals(0) || editText.getText().toString() == null){
                    count = 0;
                    Toast.makeText(pet_add_for_selling.this, "Oops. You made no entry! a Pet weight was expected", Toast.LENGTH_SHORT).show();
                }
                else{
    ...
    private void openBirthdayDialog() {
            AlertDialog.Builder builder = new AlertDialog.Builder(pet_add_for_selling.this);
            View view = View.inflate(pet_add_for_selling.this,R.layout.pet_add_birthday_dialog,null);
            ...
            save.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(pet_add_for_selling.this, formatedDate, Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
                }
            });
        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                if (textIn.getText().toString().equals("") || textIn.getText().toString() == null) {
                    Toast.makeText(pet_add_for_selling.this, "Input is empty", Toast.LENGTH_SHORT).show();
                } else {

                    AlertDialog.Builder numberBuilder = new AlertDialog.Builder(pet_add_for_selling.this);
                    View view = View.inflate(pet_add_for_selling.this, R.layout.pet_add_vaccine_taken_dialog, null);
                    ...
                    finalAlert.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                        ...
                        public void onClick(View v) {
                            ...
                            save_textOut.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    AlertDialog.Builder builder = new AlertDialog.Builder(pet_add_for_selling.this);
                                    View views = View.inflate(pet_add_for_selling.this, R.layout.pet_add_edit_vaccine_dialog, null);
                                    ...
                                    alert.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            if(counter==0){
                                                Toast.makeText(pet_add_for_selling.this, "Vaccine is empty", Toast.LENGTH_SHORT).show();
                                            }
                                            else{
                                                alert.dismiss();
                                            }
                            ...
                            removeButton.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    if(count==0){
                                        ...
                                        Toast.makeText(pet_add_for_selling.this, "Cannot make any changes", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                            if(count!=0){
    ...
    private void showCategoryDialog() {
        ...
        View pop = View.inflate(pet_add_for_selling.this,R.layout.pet_add_search_dialog,null);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(pet_add_for_selling.this, holder, Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
        ...
        addCustom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                AlertDialog.Builder builder = new AlertDialog.Builder(pet_add_for_selling.this);
                View custom = View.inflate(pet_add_for_selling.this,R.layout.pet_add_custom_breed_dialog,null);
                EditText customEdit;
                ...
                cancel = custom.findViewById(R.id.custom_breed_dialog_btn_cancel);
                  ...
                  dialogAddCustom.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                    ...
                    public void onClick(View v) {
                        ...
                        if (counter!=0){
                            Toast.makeText(pet_add_for_selling.this, customEdit.getText().toString(), Toast.LENGTH_SHORT).show();
    ...
    private void showDialogPrice() {
       ...
       AlertDialog.Builder builder = new AlertDialog.Builder(pet_add_for_selling.this);
       View view = View.inflate(pet_add_for_selling.this,R.layout.pet_add_vaccine_price_dialog,null);
       MaterialButton done, cancel;
       EditText text;
        ...
        alert.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
            ...
            public void onClick(View v) {
                if (text.getText().toString() == null || text.getText().toString().equals("")) {
                    ...
                    Toast.makeText(pet_add_for_selling.this, text.getText().toString(), Toast.LENGTH_SHORT).show();
                    counter = 1;
                }
                if(counter !=0){
                    alert.dismiss();
    ...
    private void showGenderDialog() {
        ...
        AlertDialog.Builder builder =new AlertDialog.Builder(pet_add_for_selling.this);
        View view = View.inflate(pet_add_for_selling.this,R.layout.pet_add_gender_dialog,null);
        MaterialButton done,cancel;
        ...
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(pet_add_for_selling.this, gender[Integer.parseInt(genderHolder)], Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
        cancel.setOnClickListener(new View.OnClickListener() {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == 2 && resultCode == RESULT_OK && null != data){
            ...
            if(data.getClipData() != null){
                ...
                countOfPapers = data.getClipData().getItemCount();
                for(int j = 0; j<countOfPapers; j++){

                    if(uri.size() < 5){
                        imageUriPapers = data.getClipData().getItemAt(j).getUri();
                        pet_paper_view.setVisibility(View.VISIBLE);
                        uriPapers.add(imageUriPapers);
                    }else{
                        Toast.makeText(this,"Not allowed to pick more than 5 images",Toast.LENGTH_SHORT).show();
                    }
                }
                //then notify the adapter
                pet_paper_adapter.notifyDataSetChanged();
                Toast.makeText(this,uriPapers.size()+": selected",Toast.LENGTH_SHORT).show();
            }else{
                //this is for single images
                if(uriPapers.size() <5){
                    imageUriPapers =data.getData();
                    uriPapers.add(imageUriPapers);
                    pet_paper_view.setVisibility(View.VISIBLE);
                }else{
                    Toast.makeText(this,"Not allowed to pick more than 5 images",Toast.LENGTH_SHORT).show();
            ...
            pet_paper_view.setVisibility(View.GONE);
            Toast.makeText(this,"You Haven't Pick any image",Toast.LENGTH_SHORT).show();
        }
    }


    private int uploadPaper = 0;
    int counterPaper=0;
    ArrayList<String> petPaper = new ArrayList<>();
    private void uploadToFirebaseStoragePaper(String countIDD, AlertDialog alertDialog) {
        String userID="";
        firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
        ...
        StorageReference ImageFolder = FirebaseStorage.getInstance().getReference("User/"+userID+"/"+"Pet Images/"+countIDD+"/Papers");
        for(uploadPaper = 0;uploadPaper<uriPapers.size();uploadPaper++){
            Uri Image = uriPapers.get(uploadPaper);
            final int i = uploadPaper;
            StorageReference imageName = ImageFolder.child(String.valueOf(i));
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    imageName.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uris) {
                            ...
                            petPaper.add(url);
                            if(counterPaper == uriPapers.size()){
                                //call method
                                StringLinkPaper(countIDD,alertDialog);
                            }
                        }
                        ...
                        public void onFailure(@NonNull Exception e) {
                                alertDialog.dismiss();
                            Toast.makeText(pet_add_for_selling.this, e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            });
    ...
    private void StringLinkPaper(String id,AlertDialog alertDialog) {
        ArrayList<String> hashMap = new ArrayList<String>();
        hashMap.addAll(petPaper);

        PapersClass papersClass = new PapersClass(hashMap);
        FirebaseFirestore.getInstance().collection("Pet")
                .document(id)
                .set(papersClass,SetOptions.merge()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()){
                                                FirebaseFirestore.getInstance()
                                                        ...
                                                        .collection("Pet")
                                                        .document(id)
                                                        .set(papersClass,SetOptions.merge())
                                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            @SuppressLint("SetTextI18n")
                                                            @Override
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                uploadToFirebaseStorage(id,alertDialog);
                                                            }
                                                        });
                                            }
                                        }
    ...
    private void uploadToFirebaseStorage(String countIDD, AlertDialog alertDialog) {
        String userID="";
        firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
        if (firebaseUser != null) {
            userID = firebaseUser.getUid();
        ...
        StorageReference ImageFolder = FirebaseStorage.getInstance().getReference("User/"+userID+"/"+"Pet Images/"+countIDD+"/Pet Picture");
                        ...
                        imageName.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uris) {
                                ...
                                if(counterPhotos == uri.size()){
                                    //call method
                                    StringLink(countIDD,alertDialog);
                                }
                            }
                        });
                    }
    ...
    private void StringLink(String id,AlertDialog alertDialog) {
        ArrayList<String> hashMap = new ArrayList<String>();
        hashMap.addAll(petPhotos);

        PhotoClass photo = new PhotoClass(hashMap);
        FirebaseFirestore.getInstance().collection("Pet")
                .document(id)
                .set(photo, SetOptions.merge()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                      if(task.isSuccessful()){
                          FirebaseFirestore.getInstance()
                                                              ...
                                                              FirebaseFirestore.getInstance().collection("Search")
                                                                      ...
                                                                      .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                          ...
                                                                          public void onComplete(@NonNull Task<Void> task) {
                                                                              if(task.isSuccessful()){
                                                                                  alertDialog.dismiss();
                                                                                  AlertDialog.Builder builder2 = new AlertDialog.Builder(pet_add_for_selling.this);
                                                                                  builder2.setCancelable(false);
                                                                                  View view = View.inflate(pet_add_for_selling.this,R.layout.screen_custom_alert,null);
                                                                                  //title
    ...
    private void transistion(){
        Thread mSplashThread = new Thread() {
            ...
            public void run() {
                ...
                intent.setClass(pet_add_for_selling.this, user_dashboard.class);
                pet_add_for_selling.this.overridePendingTransition(R.drawable.fade_in, R.drawable.fade_out);
    ...
    private void uploadToFirebaseDatabase() {
        ...
        if(petSize.equals("Size")){
            Toast.makeText(this, "Please enter the size of your pet (Small,Medium,Large)", Toast.LENGTH_SHORT).show();
            return;
        }
        if(petKilo.equals("Kilogram")){
            Toast.makeText(this, "Please enter the weight of your pet in kilo format", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(uriPapers.size() == 0){
            Toast.makeText(this, "Please provide a picture of Legal papers of your pet", Toast.LENGTH_SHORT).show();
            return;
        }
                                        ...
                                        FirebaseFirestore.getInstance().collection("User")
                                                ...
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        FirebaseFirestore.getInstance().collection("Pet")
                                                                        .document(documentReference.getId())
                                                                                .update("timestamp", FieldValue.serverTimestamp(),"id",documentReference.getId()).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                    @Override
                                                                    public void onSuccess(Void unused) {
                                                                        FirebaseFirestore.getInstance().collection("Shop")
                                                                                ...
                                                                                .collection("Pet")
                                                                                .document(documentReference.getId())
                                                                                .update("timestamp", FieldValue.serverTimestamp()).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                    @Override
                                                                                    public void onSuccess(Void unused) {
                                                                                            FirebaseFirestore.getInstance().collection("User")
                                                                                                    ...
                                                                                                    .update("timestamp", FieldValue.serverTimestamp()).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                                        @Override
                                                                                                        public void onSuccess(Void unused) {
                                                                                                            uploadToFirebaseStoragePaper(documentReference.getId(),alert2);
                                                                                                        }
                                                                                                    });
                                                                                    }
                                                                                });
