...
public class order_breeder_pending extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_order_breeder_pending, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        pendingRecycler.setLayoutManager(new GridLayoutManager(getActivity(),1));
