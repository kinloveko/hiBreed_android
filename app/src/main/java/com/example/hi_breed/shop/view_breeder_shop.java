...
public class view_breeder_shop  extends BaseActivity {
    FirebaseUser firebaseUser;

    TabLayout tabLayout;
    ViewPager2 viewPager;
    ViewPagerAdapter adapterV;
    TextView viewShopName,viewShopVerified,viewShopReviews,editShop;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shop_breeder_view);
        ...
        backLayoutShop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                view_breeder_shop.this.onBackPressed();
            }
        });
