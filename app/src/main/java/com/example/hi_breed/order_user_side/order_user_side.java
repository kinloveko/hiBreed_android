...
public class order_user_side extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_user_side);
        ...
        toolbarID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(order_user_side.this, user_dashboard.class));
                finish();
            }
        });
        ...
        viewPagerAdapter.addFragment(new order_pending_fragment(), "Pending");
        viewPagerAdapter.addFragment(new order_accepted_fragment(), "Accepted");
        viewPagerAdapter.addFragment(new order_completed_fragment(), "Completed");
        viewPagerAdapter.addFragment(new order_cancelled_fragment(), "Cancelled");
